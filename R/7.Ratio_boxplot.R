...
library(stringr)
args=commandArgs(T)
# args <- c("/home/zhl/projects/batch_effect_correction/new_results/Ratio_3species_allmethod/uniprot-Ecoli_K12_201709_Ratio.csv",
#           "/home/zhl/projects/batch_effect_correction/new_results/Ratio_3species_allmethod/ecoli.png",
#           "/home/zhl/projects/batch_effect_correction/new_results/Ratio_3species_allmethod/ecoli.pdf")
...
p <- ggplot(df_t,aes(y=value,x=Method,fill=Method))+
  geom_boxplot(position=position_dodge(2),alpha=0.8,outlier.size = 0.5,width=0.2)+
  geom_violin(adjust = 1,trim = FALSE,alpha=0.8,width=5)+
